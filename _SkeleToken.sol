...
// Skeleton token contract, for experimentation
// based on '0xLitecoin Token' contract
// Mineable ERC20 Token using Proof Of Work

/*
the idea is that the miner uses proxyMergeMint in https://github.com/snissn/0xlitecoin-token/blob/master/contracts/MintHelper.sol#L269
...
contract _SkeleToken is ERC20Interface, Owned {
    ...
    // the goal is for 0xLitecoin to be mined with Dummy0xBTC
    ...
    function _SkeleToken() public onlyOwner{
        ...
        miningTarget = 27938697607979437428382017032425071986904332731688489302005732; // from Dummy0xBitcoin as of block 5902249
        ...
        function merge() public returns (bool success) {
            ...
            // the idea is that the miner uses https://github.com/Dummy0xBitcoin/mint-helper/blob/master/contracts/MintHelper.sol 
            // to call mint() and then mergeMint() in the same transaction



            // hard code a reference to the "Parent" ERC918 Contract ( in this case Dummy0xBitcoin)
            ...
            // is the sender that has called mint
             ...
             //0xLTC will have the same challenge numbers as Dummy0xBitcoin, this means that mining for one is literally the same process as mining for the other
    ...
    function _reAdjustDifficulty() internal {
        ...
        //we want miners to spend 15 minutes to mine each 'block', about 60 ethereum blocks = one 0xLitecoin epoch = one Dummy0xBitcoin
